...
public class UserTestData {
    ...
    public static TestMatcher<User> USER_WITH_MEALS_MATCHER = TestMatcher.usingFieldsWithIgnoringComparator(User.class, "registered");
    ...
    static {
        USER_WITH_MEALS = new User(USER);
        USER_WITH_MEALS.setMeals(MealTestData.MEALS);
    }
